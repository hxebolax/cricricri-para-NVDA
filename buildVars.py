...
addon_info = {
	...
	"addon_name": "cricricri",
	# Add-on summary, usually the user visible name of the addon.
	# Translators: Summary for this add-on to be shown on installation and add-on information.
	"addon_summary": _("cricricri"),
	# Add-on description
	# Translators: Long description to be shown for this add-on on add-on information from add-ons manager
	"addon_description": _("Complemento para cambiar el puñetero manifiesto"),
	# version
	"addon_version": "0.2.1",
	# Author(s)
	"addon_author": u"Héctor J. Benítez Corredera <xebolax@gmail.com>",
	# URL for the add-on documentation support
	"addon_url": "https://github.com/hxebolax/cricricri-para-NVDA",
...
pythonSources = [os.path.join("addon", "globalPlugins", "cricricri", "*.py")]
